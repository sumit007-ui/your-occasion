...
export function DeleteUserButton({ userId, userName, onDelete }: DeleteUserButtonProps) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.success("User record has been permanently removed.");
  ...
  return (
    <>
      <button
        ...
        className="w-10 h-10 flex items-center justify-center border border-white/5 text-on-surface-variant hover:text-red-500 hover:border-red-500/30 transition-all group"
        title="Delete User"
      >
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="font-display text-4xl text-white italic mb-4 tracking-tight">Remove Profile</h3>
                <p className="text-on-surface-variant text-[11px] uppercase tracking-[0.2em] font-light leading-relaxed mb-10 max-w-[280px]">
                  You are about to delete the profile for <span className="text-white font-bold">{userName || 'this user'}</span>. This action is irreversible.
                </p>
